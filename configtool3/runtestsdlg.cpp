        ...
        else
        {
            ...
            else
            {
                ...
                if (wxGetApp().GetSettings().GetRunTestsSettings().m_bSerial)
                    ...
                    strPort = wxString(CeCosSocket::HostPort(wxGetApp().GetSettings().GetRunTestsSettings().m_strLocalTCPIPHost,wxGetApp().GetSettings().GetRunTestsSettings().m_nLocalTCPIPPort));
                if(0==strPort.Length()){
