...
#else
	wxIcon m_icons;
	m_icons.LoadFile("bitmaps\\closedfolder.ico", wxBITMAP_TYPE_ICO);
	m_iconDB.AddInfo("Container", m_icons, 0, TRUE);
	m_icons.LoadFile("bitmaps\\closedfolder_dis.ico", wxBITMAP_TYPE_ICO);
	m_iconDB.AddInfo("Container", m_icons, 0, FALSE);

	m_icons.LoadFile("bitmaps\\package_open.ico", wxBITMAP_TYPE_ICO);
	m_iconDB.AddInfo("Package", m_icons, 0, TRUE);
	m_icons.LoadFile("bitmaps\\package_open_dis.ico", wxBITMAP_TYPE_ICO);
	m_iconDB.AddInfo("Package", m_icons, 0, FALSE);

	m_icons.LoadFile("bitmaps\\checked.ico", wxBITMAP_TYPE_ICO);
	m_iconDB.AddInfo("Checkbox", m_icons, 0, TRUE);
	m_icons.LoadFile("bitmaps\\checked_dis.ico", wxBITMAP_TYPE_ICO);
	m_iconDB.AddInfo("Checkbox", m_icons, 0, FALSE);
	m_icons.LoadFile("bitmaps\\unchecked.ico", wxBITMAP_TYPE_ICO);
	m_iconDB.AddInfo("Checkbox", m_icons, 1, TRUE);
	m_icons.LoadFile("bitmaps\\unchecked_dis.ico", wxBITMAP_TYPE_ICO);
	m_iconDB.AddInfo("Checkbox", m_icons, 1, FALSE);

	m_icons.LoadFile("bitmaps\\radioon.ico", wxBITMAP_TYPE_ICO);
	m_iconDB.AddInfo("Radiobox", m_icons, 0, TRUE);
	m_icons.LoadFile("bitmaps\\radioon_dis.ico", wxBITMAP_TYPE_ICO);
	m_iconDB.AddInfo("Radiobox", m_icons, 0, FALSE);
	m_icons.LoadFile("bitmaps\\radiooff.ico", wxBITMAP_TYPE_ICO);
	m_iconDB.AddInfo("Radiobox", m_icons, 1, TRUE);
	m_icons.LoadFile("bitmaps\\radiooff_dis.ico", wxBITMAP_TYPE_ICO);
	m_iconDB.AddInfo("Radiobox", m_icons, 1, FALSE);

	m_icons.LoadFile("bitmaps\\text.ico", wxBITMAP_TYPE_ICO);
	m_iconDB.AddInfo("Text", m_icons, 0, TRUE);
	m_icons.LoadFile("bitmaps\\text_dis.ico", wxBITMAP_TYPE_ICO);
	m_iconDB.AddInfo("Text", m_icons, 0, FALSE);

	m_icons.LoadFile("bitmaps\\enumerated.ico", wxBITMAP_TYPE_ICO);
	m_iconDB.AddInfo("Enumerated", m_icons, 0, TRUE);
	m_icons.LoadFile("bitmaps\\enumerated_dis.ico", wxBITMAP_TYPE_ICO);
	m_iconDB.AddInfo("Enumerated", m_icons, 0, FALSE);

	m_icons.LoadFile("bitmaps\\integer.ico", wxBITMAP_TYPE_ICO);
	m_iconDB.AddInfo("Integer", m_icons, 0, TRUE);
	m_icons.LoadFile("bitmaps\\integer_dis.ico", wxBITMAP_TYPE_ICO);
	m_iconDB.AddInfo("Integer", m_icons, 0, FALSE);
