...
#else
	wxIcon m_icons;
	m_icons.LoadFile("bitmaps\\configtool.ico", wxBITMAP_TYPE_ICO);
	wxGetApp().SetMainIcon(m_icons);
	// set the frame icon
	SetIcon(m_icons);
#endif
...
#else
	toolBarBitmaps[0].LoadFile(L"bitmaps\\new.bmp", wxBITMAP_TYPE_BMP);
	toolBarBitmaps[1].LoadFile(L"bitmaps\\open.bmp", wxBITMAP_TYPE_BMP);
	toolBarBitmaps[2].LoadFile(L"bitmaps\\save.bmp", wxBITMAP_TYPE_BMP);
	toolBarBitmaps[3].LoadFile(L"bitmaps\\copy.bmp", wxBITMAP_TYPE_BMP);
	toolBarBitmaps[4].LoadFile(L"bitmaps\\cut.bmp", wxBITMAP_TYPE_BMP);
	toolBarBitmaps[5].LoadFile(L"bitmaps\\paste.bmp", wxBITMAP_TYPE_BMP);
	toolBarBitmaps[6].LoadFile(L"bitmaps\\search.bmp", wxBITMAP_TYPE_BMP);
	toolBarBitmaps[7].LoadFile(L"bitmaps\\stopbuild.bmp", wxBITMAP_TYPE_BMP);
	toolBarBitmaps[8].LoadFile(L"bitmaps\\buildlibrary.bmp", wxBITMAP_TYPE_BMP);
	toolBarBitmaps[9].LoadFile(L"bitmaps\\help.bmp", wxBITMAP_TYPE_BMP);
	toolBarBitmaps[10].LoadFile(L"bitmaps\\newregion.bmp", wxBITMAP_TYPE_BMP);
	toolBarBitmaps[11].LoadFile(L"bitmaps\\newsection.bmp", wxBITMAP_TYPE_BMP);
	toolBarBitmaps[12].LoadFile(L"bitmaps\\delete.bmp", wxBITMAP_TYPE_BMP);
	toolBarBitmaps[13].LoadFile(L"bitmaps\\properties.bmp", wxBITMAP_TYPE_BMP);
	toolBarBitmaps[14].LoadFile(L"bitmaps\\cshelp.bmp", wxBITMAP_TYPE_BMP);
#endif
